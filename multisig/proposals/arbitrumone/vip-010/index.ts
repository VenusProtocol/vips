...
const vip010 = () => {
  return makeProposal([
    ...
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "addPool(string,address,uint256,uint256,uint256)", arbitrumone.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "addMarket(AddMarketInput)", arbitrumone.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "setPoolName(address,string)", arbitrumone.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "updatePoolMetadata(address,VenusPoolMetaData)", arbitrumone.GUARDIAN],
    },
  ]);
};
