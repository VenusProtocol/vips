  ...
  return makeProposal([
    {
      ...
      params: ["0x0000000000000000000000000000000000000000", "pause()", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "unpause()", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setOracle(address,address,uint8)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "enableOracle(address,uint8,bool)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setTokenConfig(TokenConfig)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setDirectPrice(address,uint256)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setValidateConfig(ValidateConfig)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setMaxStalePeriod(string,uint256)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setSymbolOverride(string,string)", ETHEREUM_MULTISIG],
    },
    {
      target: ACM,
      signature: "giveCallPermission(address,string,address)",
      params: ["0x0000000000000000000000000000000000000000", "setUnderlyingPythOracle(address)", ETHEREUM_MULTISIG],
    },
