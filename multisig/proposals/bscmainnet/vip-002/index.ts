  ...
  return makeProposal([
    {
      ...
      params: [
        ...
        [Action.REDEEM, Action.SEIZE, Action.TRANSFER, Action.EXIT_MARKET],
        false
      ],
    },
    {
      ...
      signature: "_setActionsPaused(address[],uint8[],bool)",
      params: [
        Object.values(allVTokens).filter(vToken => vToken !== allVTokens.vBUSD),
        [Action.LIQUIDATE],
        false
      ],
    },
    {
      ...
      signature: "_setActionsPaused(address[],uint8[],bool)",
      params: [
        Object.values(allVTokens).filter(
          vToken => vToken !== allVTokens.vBUSD && 
          vToken !== allVTokens.vSXP && 
          vToken !== allVTokens.vXVS && 
          vToken !== allVTokens.vBETH && 
          vToken !== allVTokens.vTUSDOLD && 
          vToken !== allVTokens.vTRXOLD &&
          vToken !== allVTokens["vPT-sUSDE-26JUN2025"] &&
          vToken !== allVTokens.vsUSDe &&
          vToken !== allVTokens.vxSolvBTC &&
          vToken !== allVTokens.vasBNB
        ),
        [Action.BORROW],
        false
      ],
