...
const vip052 = () => {
  return makeProposal([
    ...
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "addPool(string,address,uint256,uint256,uint256)", sepolia.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "addMarket(AddMarketInput)", sepolia.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "setPoolName(address,string)", sepolia.GUARDIAN],
    },
    {
      target: ACM,
      signature: "revokeCallPermission(address,string,address)",
      params: [POOL_REGISTRY, "updatePoolMetadata(address,VenusPoolMetaData)", sepolia.GUARDIAN],
    },
  ]);
};
