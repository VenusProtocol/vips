...
export const vtokenConfiguration = () => {
  const meta = {
    version: "v2",
    title: "Sepolia markets Configuration",
    description: `
      This Multisig TX configures the markets deployed on sepolia:
      `,
    forDescription: "I agree that Venus Protocol should proceed with the deployments",
    againstDescription: "I do not think that Venus Protocol should proceed with the deployments",
    abstainDescription: "I am indifferent to whether Venus Protocol proceeds with the deployments or not",
  };
