...
forking(44548900, async () => {
  ...
  describe("Post-Execution state", () => {
    ...
    it("Should emit an event on successful bridging of XVS (Zksync mainnet -> OP mainnet)", async () => {
