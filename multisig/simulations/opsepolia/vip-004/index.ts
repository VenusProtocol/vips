...
import vip004, {
  ...
  VWETH_CORE,
  WETH,
} from "../../../proposals/opsepolia/vip-004";
...
const POOL_REGISTRY = opsepolia.POOL_REGISTRY;

const BLOCKS_PER_YEAR = BigNumber.from("31536000"); // equal to seconds in a year as it is timebased deployment

type VTokenSymbol = "vWBTC_Core" | "vWETH_Core" | "vUSDT_Core" | "vUSDC_Core" | "vOP_Core";
...
const interestRateModels: InterestRateModelSpec[] = [
  {
    vTokens: ["vWBTC_Core", "vWETH_Core", "vOP_Core"],
    kink: "0.45",
    base: "0",
    multiplier: "0.09",
    jump: "3",
...
forking(17082725, async () => {
  ...
  describe("Post-Execution state", () => {
    before(async () => {
      const WETH_ACCOUNT = "0xff44346743550D9c973aaC5baA2ac819d75D0c18";
