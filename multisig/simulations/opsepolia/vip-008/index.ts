...
forking(22912174, async () => {
  ...
  describe("Pre-VIP behavior", async () => {
    before(async () => {
      ...
      poolRegistry = new ethers.Contract(opsepolia.POOL_REGISTRY, OWNERSHIP_ABI, provider);
      xvsVault = new ethers.Contract(opsepolia.XVS_VAULT_PROXY, OWNERSHIP_ABI, provider);
