...
import vip028, {
  CORE_COMPTROLLER_ADDRESS, CRV_COMPTROLLER_ADDRESS, ETH_COMPTROLLER_ADDRESS, DAI_ADDRESS, DAI_SUPPLY_CAP, DAI_BORROW_CAP,
  FRAX_ADDRESS,FRAX_SUPPLY_CAP, FRAX_BORROW_CAP, crvUSD_ADDRESS, crvUSD_SUPPLY_CAP, crvUSD_BORROW_CAP, CRV_ADDRESS, CRV_SUPPLY_CAP,
  CRV_BORROW_CAP, ETH_weETH_SUPPLY_CAP, ETH_weETH_BORROW_CAP, ETH_weETH_ADDRESS
