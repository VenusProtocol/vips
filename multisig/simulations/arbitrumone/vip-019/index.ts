...
forking(291641176, async () => {
  ...
  describe("Pre-VIP behavior", async () => {
    before(async () => {
      ...
      poolRegistry = new ethers.Contract(arbitrumone.POOL_REGISTRY, OWNERSHIP_ABI, provider);
      xvsVault = new ethers.Contract(arbitrumone.XVS_VAULT_PROXY, OWNERSHIP_ABI, provider);
      ...
      treasury = await ethers.getContractAt(OWNERSHIP_ABI, NETWORK_ADDRESSES.arbitrumone.VTREASURY);
    });
