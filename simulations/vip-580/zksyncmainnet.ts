...
import vip580, { ZKSYNC_SPEED, ZKSYNC_XVS_BRIDGE_AMOUNT, ZKSYNC_XVS_STORE } from "../../vips/vip-580/bscmainnet";
...
forking(67612987, async () => {
  ...
  testForkedNetworkVipCommands("VIP 580", await vip580());
