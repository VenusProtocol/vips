...
import { ACM, DEVIATION_SENTINEL, vip580TestnetAddendum } from "../../vips/vip-580/bsctestnet-addendum";
...
forking(82830213, async () => {
  ...
  testVip("VIP-580 Addendum: Grant _setActionsPaused permission", await vip580TestnetAddendum(), {
