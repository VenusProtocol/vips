...
import vip570 from "../../vips/vip-570/bsctestnet";
      ...
      for (const vToken of isolatedPoolsVTokens) {
        ...
        describe(`${vToken.symbol} rate curve`, () => {
          ...
          it("set to 70080000 blocks per year", async () => {
            ...
            expect(await rateModel.blocksOrSecondsPerYear()).to.equal(70080000);
          });
        });
      }
    });
