...
import { OPBNBTESTNET_ACM, OPBNBTESTNET_NORMAL_TIMELOCK, vip306 } from "../../vips/vip-306/bsctestnet";
...
forking(28821437, async () => {
  ...
  testForkedNetworkVipCommands("vip302 configures bridge", await vip306(), {
