...
import vip512, { COMPTROLLER_CORE_ETH, USDT_ETH, tBTCMarketSpec } from "../../vips/vip-512/bscmainnet";
...
forking(22659246, async () => {
  ...
  testForkedNetworkVipCommands("tBTC Market", await vip512(ONE_YEAR));
  ...
  describe("Post-Execution state", () => {
    ...
    describe("Prices", () => {
      it("get correct price from oracle for tBTC", async () => {
        ...
        expect(price).to.equal(parseUnits("105181.545", 18));
      });
    });
