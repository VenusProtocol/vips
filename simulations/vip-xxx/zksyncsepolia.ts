...
import vipxxx, { ACCESS_CONTROL_MANAGER_ZKSYNCSEPOLIA, ANY_TARGET_CONTRACT, MARKET_CAP_RISK_STEWARD_ZKSYNCSEPOLIA } from "../../vips/vip-xxx/bsctestnet-crosschain";
...
forking(4898583, async () => {
  ...
  describe("Post-VIP behavior", () => {
    ...
    it("Market Cap Risk Steward should be able to set supply and borrow caps on markets", async () => {
      ...
      await expect(isolatedPoolComptroller.connect(await ethers.getSigner(MARKET_CAP_RISK_STEWARD_ZKSYNCSEPOLIA))
