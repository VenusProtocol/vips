...
import { XVS, XVS_AMOUNT, XVS_BRIDGE_SRC, vip350 } from "../../vips/vip-350/bsctestnet";
import COMPTROLLER_ABI from "./abi/Comptroller.json";
import ERC20_ABI from "./abi/ERC20.json";
import XVS_BRIDGE_ABI from "./abi/XVSProxyOFTSrc.json";

forking(42913793, async () => {
  ...
  testVip("VIP-350 Send XVS to Dest Chain(zksync sepolia)", await vip350(), {
