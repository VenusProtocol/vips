...
import vip316, { COMMUNITY_WALLET, TOKEN_REDEEMER, TREASURY, VUSDC, VUSDC_AMOUNT } from "../../vips/vip-316/bscmainnet";
...
forking(39149089, () => {
  ...
  describe("Post-VIP behavior", async () => {
    it("should decrease vtreasury balance by the amount used to transfer vtoken corresponding to 25000 usdc", async () => {
      expect(await vusdc.balanceOf(TREASURY)).to.closeTo(prevTreasuryBalance.sub(VUSDC_AMOUNT), parseUnits("700", 8));
    });
