...
const prices = [
...

  {
    ...
    expectedPrice: parseUnits("1.6655684", 18),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("0.99928668", 18),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("106349.3", 28),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("1.128807410443962906", 18),
    expectedPriceAfterVIP: parseUnits("1.129086860966686667", 18),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("1.053382297572219154", 18),
    expectedPriceAfterVIP: parseUnits("1.053637733033718784", 18),
  ...
  },
  {
    ...
    expectedPrice: parseUnits("0.99977968", 30),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("2661.44", 18),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("2732.614486572944721374", 18),
    postVIP: async function (resilientOracle: any, address: string) {
      const vtoken = new ethers.Contract(address, VTOKEN_ABI, ethers.provider);
      const underlying = await vtoken.underlying();
      const token = new ethers.Contract(underlying, ERC20_ABI, ethers.provider);
  ...
  },
  {
    ...
    expectedPrice: parseUnits("1.06222291947376", 30),
    expectedPriceAfterVIP: parseUnits("1.06228490581392", 30),
  },
  {
    symbol: "vyvUSDT",
    address: "0x475d0C68a8CD275c15D1F01F4f291804E445F677",
    expectedPrice: parseUnits("1.04017106019732", 30),
    expectedPriceAfterVIP: parseUnits("1.04036110679862", 30),
  },
  {
    symbol: "vyvUSDS",
    address: "0x520d67226Bc904aC122dcE66ed2f8f61AA1ED764",
    expectedPrice: parseUnits("1.048357264231286377", 18),
    expectedPriceAfterVIP: parseUnits("1.048489490602703418", 18),
  },
  {
    symbol: "vyvWETH",
    address: "0xba3916302cBA4aBcB51a01e706fC6051AaF272A0",
    expectedPrice: parseUnits("2732.842781715486438421", 18),
    expectedPriceAfterVIP: parseUnits("2732.966507769147649406", 18),
  },
  {
    symbol: "vPT-sUSDE",
    address: "0xCca202a95E8096315E3F19E46e19E1b326634889",
    expectedPrice: parseUnits("0.9997878", 18),
    expectedPriceAfterVIP: parseUnits("0.9995315", 18),
  ...
  },
  {
    ...
    expectedPrice: parseUnits("1.174409218193628301", 18),
    expectedPriceAfterVIP: parseUnits("1.174139327683366608", 18),
  },
  {
    symbol: "vezETH",
    address: "0xA854D35664c658280fFf27B6eDC6C4195c3229B3",
    expectedPrice: parseUnits("2793.9434631872", 18),
    expectedPriceAfterVIP: parseUnits("2793.198730735535949920", 18),
    postVIP: async function () {
      await setMaxStalePeriodInChainlinkOracle(
        CHAINLINK_ORACLE,
  ...
  },
  {
    ...
    expectedPrice: parseUnits("2790.3041835168", 18),
    preVIP: async function () {
      await setRedstonePrice(
        REDSTONE_ORACLE,
  ...
  },
  {
    ...
    expectedPrice: parseUnits("2780.8828189888", 18),
    expectedPriceAfterVIP: parseUnits("2781.157040261858216160", 18),
    postVIP: async function () {
      await setMaxStalePeriodInChainlinkOracle(
        CHAINLINK_ORACLE,
...
forking(22590117, async () => {
  ...
  testForkedNetworkVipCommands("vip506", await vip506(), {
