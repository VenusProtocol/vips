      ...
      describe(`${vTokenSpec.symbol}`, () => {
        ...
        describe(`${vTokenSpec.symbol}`, () => {
          it(`should have correct initial supply`, async () => {
            expect(await vTokenContract.balanceOf(initialSupply.vTokenReceiver)).to.equal(parseUnits("17.98307953", 8));
          });
        });
      });
    });
