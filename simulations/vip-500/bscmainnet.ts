  ...
  describe("Post-VIP state", () => {
    describe("Oracle configuration", async () => {
      it("has the correct PT-SolvBTC.BBN-27MAR2025 price", async () => {
        ...
        expect(price).to.be.eq(parseUnits("99905.523680516349160719", 18));
      });
    });
