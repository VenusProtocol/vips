...
import vip500, { COMPTROLLER, PRIME, newMarkets, tokens } from "../../vips/vip-500/bsctestnet";
...
forking(46631818, async () => {
  ...
  testVip("BTC pool VIP", await vip500());
  ...
  describe("Post-VIP state", () => {
    describe("Oracle configuration", async () => {
      it("has the correct PT-SolvBTC.BBN-27MAR2025 price", async () => {
        ...
        expect(price).to.be.eq(parseUnits("110335.748676148675101823", 18));
      });
    });
