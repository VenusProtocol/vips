...
import { COMMUNITY_WALLET, ETH, XVS, XVS_AMOUNT, XVS_BRIDGE_SRC, vip368 } from "../../vips/vip-368/bscmainnet";
...
forking(42389720, async () => {
  ...
  testVip("VIP-368 Send XVS to Dest Chain(zksync mainnet)", await vip368(), {
