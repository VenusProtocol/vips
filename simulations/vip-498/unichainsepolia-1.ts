...
import { vip498, weETH, wstETH, WETH_ORACLE, WSTETH_ORACLE } from "../../vips/vip-498/bsctestnet-1";
...
forking(20881282, async () => {
  ...
  testForkedNetworkVipCommands("Oracle configuration", await vip498());
  ...
  describe("weETH Oracle Configuration", () => {
    ...
    it("should set correct snapshot parameters", async () => {
      const expectedRate = parseUnits("1.06778921", 18)
        .mul(503)
        .div(10000)
        .add(parseUnits("1.06778921", 18));
  ...
  describe("wstETH Oracle Configuration", () => {
    ...
    it("should set correct snapshot parameters", async () => {
      const expectedRate = parseUnits("1.20297267", 18)
        .mul(607)
        .div(10000)
        .add(parseUnits("1.20297267", 18));
