...
} from "../../vips/vip-498/bscmainnet-2";
...
forking(22475162, async () => {
  ...
  testForkedNetworkVipCommands("VIP-498 part 1", await bscmainnetVip498());
  testForkedNetworkVipCommands("VIP-498 part 2", await bscmainnet2Vip498());
