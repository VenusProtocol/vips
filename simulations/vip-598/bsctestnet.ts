...
import vip598, { NEW_CF, NEW_LI, NEW_LT, vslisBNB } from "../../vips/vip-598/bsctestnet";
...
forking(93906956, async () => {
  ...
  testVip("VIP-598 testnet [BNB Chain] slisBNB Core Pool Risk Parameter Update", await vip598(), {
