...
const old_VUSDT_IR = "0x1485A27D95D3d2878a6641055dD3a643F296CCf6";
const old_VUSDC_IR = "0x1485A27D95D3d2878a6641055dD3a643F296CCf6";
...
const old_VUSDT_StableCoin_IR = "0x5E0dB1e8a6D6181aa39B3317179CDF91FBa4Ac51";
...
// TODO: change fork block after phase 2/3 is applied on-chain
forking(37774366, () => {
  let vusdt: Contract;
  let vusdc: Contract;
  let vdai: Contract;
  ...
  testVip("VIP-290 Chaos lab recommendation 3/3", vip290(), {
