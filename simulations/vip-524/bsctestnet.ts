  ...
  describe("Pre-VIP behaviour", async () => {
    describe("Old distribution speed", () => {
      it("has the old XVS distribution speed", async () => {
        const OLD_BSCTESTNET_XVS_PER_BLOCK_REWARD = parseUnits("0.005", 18);
      ...
      it("has the old VAI vault rate", async () => {
        const OLD_BSCTESTNET_VAI_VAULT_RATE_PER_BLOCK = parseUnits("0.096", 18).toString();
      ...
      it("has the old BTCB distribution speed", async () => {
        const OLD_BSCTESTNET_BTCB_PER_BLOCK_REWARD = parseUnits("0.000000630787037037", 18);
      ...
      it("has the old ETH distribution speed", async () => {
        const OLD_BSCTESTNET_WETH_PER_BLOCK_REWARD = parseUnits("0.000012219328703703", 18);
      ...
      it("has the old USDC distribution speed", async () => {
        const OLD_BSCTESTNET_USDC_PER_BLOCK_REWARD = parseUnits("0.018440", 6);
      ...
      it("has the old USDT distribution speed", async () => {
        const OLD_BSCTESTNET_USDT_PER_BLOCK_REWARD = parseUnits("0.043595", 6);
