...
import vip427, { COMPTROLLER, WUSDM_ERC4626_ORACLE, newMarket, tokens } from "../../vips/vip-427/bscmainnet";
...
forking(54123200, async () => {
  ...
  testForkedNetworkVipCommands("zksync-wUSDM", await vip427({ chainlinkStalePeriod: ONE_YEAR }));
