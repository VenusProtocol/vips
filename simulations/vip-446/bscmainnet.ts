...
import {
  ...
  vip446,
} from "../../vips/vip-446/bscmainnet";
import CORE_COMPTROLLER_ABI from "./abi/CoreComptroller.json";

const vTHE_CORE_SUPPLY_CAP_PREV = parseUnits("4800000", 18);
const vTHE_CORE_BORROW_CAP_PREV = parseUnits("2400000", 18);

forking(46454600, async () => {
