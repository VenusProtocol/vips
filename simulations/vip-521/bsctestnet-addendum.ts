...
import { USDFMarketSpec } from "../../vips/vip-521/bsctestnet";
import { BURNING_CONVERTER, CONVERSION_INCENTIVE, WBNB, vip521addendum } from "../../vips/vip-521/bsctestnet-addendum";
import SINGLE_TOKEN_CONVERTER_ABI from "./abi/SingleTokenConverter.json";

forking(54651835, async () => {
  testVip("vip-521 Addendum", await vip521addendum(), {});
