...
import { ARBITRUMONE_ISOLATED_VTOKENS, ARBITRUMONE_LST_COMPTROLLER } from "../../vips/vip-803/addresses/arbitrumone";
import vip803 from "../../vips/vip-803/bscmainnet";
...
forking(BLOCK_NUMBER, async () => {
  ...
  testForkedNetworkVipCommands(
    "VIP-803 Grant syncCash permissions and call syncCash on isolated pools",
    await vip803(),
  );
