...
import { Actions, ETHEREUM_COMPTROLLER, ETHEREUM_VTOKENS, vip510 } from "../../vips/vip-510/bsctestnet";
import COMPTROLLER_ABI from "./abi/Comptroller.json";

forking(8432182, async () => {
  ...
  testForkedNetworkVipCommands("VIP-510", await vip510(), {
    callbackAfterExecution: async txResponse => {
      await expectEvents(
        ...
        [27, 9, 0], // 0 events for "NewLiquidationThreshold" shows that there's no change in LiquidationThreshold .
      );
    },
  });
