...
export const NETWORK_ADDRESSES = {
  ...
  bsctestnet: {
    ...
    FAST_TRACK_TIMELOCK: bsctestnet_deployed_contracts.contracts.FastTrackTimelock.address,
  ...
  sepolia: {
    ...
    ACM: sepolia_deployed_contracts.contracts.AccessControlManager.address,
