...
export const vxSolvBTC_BSC_SUPPLY_CAP = parseUnits("500", 18);

export const vip519 = async () => {
  const meta: ProposalMeta = {
    version: "v2",
    title: "VIP-519 [BNB Chain] Risk Parameters Adjustments (xSolvBTC)",
...
Labs - Risk Parameter Updates - 06/21/25](https://community.venus.io/t/chaos-labs-risk-parameter-updates-06-21-25/5156):

- [xSolvBTC (Core pool)](https://app.venus.io/#/core-pool/market/0xd804dE60aFD05EE6B89aab5D152258fD461B07D5?chainId=56):
increase the Supply Cap, from 250 xSolvBTC to 500 xSolvBTC

Complete analysis and details of this recommendation are available in the above publication.

#### References
- [VIP simulation](https://github.com/VenusProtocol/vips/pull/581)`,
