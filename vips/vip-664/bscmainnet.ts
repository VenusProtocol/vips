...
// TODO: replace with mainnet deployment address before proposing
...
// ──────────────────────────────────────────────────────────────────────
// Liquidator / Settler whitelists
// ──────────────────────────────────────────────────────────────────────
// On mainnet the Guardian is NOT whitelisted; dedicated operator addresses
// are used instead. Populate before proposing.

// TODO: replace with mainnet liquidator addresses before proposing
export const LIQUIDATOR_WHITELIST: string[] = [];
// TODO: replace with mainnet settler addresses before proposing
export const SETTLER_WHITELIST: string[] = [];
...
| Guardian | LiquidationAdapter | 3 functions (sweep + whitelist management) |`,
  ...
  return makeProposal(
    [
      ...
      // ──────────────────────────────────────────────────────────────────────
      // Load the batch into the aggregator, grant admin role, execute batched
      // permissions, then revoke admin role.
      ...
      // ──────────────────────────────────────────────────────────────────────
      // Phase 4 — Liquidator / settler whitelist configuration
      // ──────────────────────────────────────────────────────────────────────
