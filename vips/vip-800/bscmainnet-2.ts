...
export const EMODE_POOLS = [
  createEmodePool("LTC", 11, "vLTC", vLTC, "0.63"),
  createEmodePool("FIL", 12, "vFIL", vFIL, "0.63"),
  createEmodePool("MATIC", 13, "vMATIC", vMATIC, "0", { liquidationThreshold: "0.65" }),
  createEmodePool("TRX", 14, "vTRX", vTRX, "0.525"),
  createEmodePool("DOT", 15, "vDOT", vDOT, "0.65"),
  createEmodePool("THE", 16, "vTHE", vTHE, "0.53"),
];
