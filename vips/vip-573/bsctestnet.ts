...
import { cutParams as params } from "../../simulations/vip-573/utils/cut-params-bsctestnet.json";
...
export const vip573 = () => {
  const meta = {
    version: "v2",
    title: "VIP-573 [BNB Chain Testnet] Add enterMarketBehalf support to Comptroller",
    description: `#### Summary
