...
// vips/vip-662/scripts/fetchCoreMarketOracles.ts. Each one is today configured as
...
export const vip662 = () => {
  const meta = {
    version: "v2",
    title: "VIP-662 [BNB Chain] Oracle Adjustments, VAI Vault Rewards Stop, and Treasury and Risk Fund Cleanup",
    description: `#### Summary
