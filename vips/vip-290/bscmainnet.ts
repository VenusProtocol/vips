...
const VUSDT_IR = "0x12894dB18981153c131144aC4f8dd34fd873b51D";
const VUSDC_IR = "0x12894dB18981153c131144aC4f8dd34fd873b51D";
const VDAI_IR = "0x12894dB18981153c131144aC4f8dd34fd873b51D";
const VFDUSD_IR = "0x9ea917D80724F80f7e73106DC0EEe0A60f34461F";
const VTUSD_IR = "0x12894dB18981153c131144aC4f8dd34fd873b51D";
const VUSDT_StableCoin_IR = "0xB3cD4A0723Ae32da07E82367A2CBe79Fa8fa25C7";
const VUSDT_GameFi_IR = "0x044e2244C5e5B598a2A14f08fa1a68cC17Ca1029";
const VUSDT_DeFi_IR = "0x044e2244C5e5B598a2A14f08fa1a68cC17Ca1029";

export const vip290 = () => {
  const meta = {
    version: "v2",
    title: "VIP-290 Risk Parameters Adjustments Phase 3/3 (Stablecoins)",
...
- opBNB
    - Increase multiplier (annualized), from 0.125 (10% APR at kink) to 0.15 (12% APR at kink): [FDUSD (Core pool)](https://opbnbscan.com/address/0x13B492B8A03d072Bab5C54AC91Dba5b830a50917), [USDT (Core pool)](https://opbnbscan.com/address/0xb7a01Ba126830692238521a1aA7E7A7509410b8e)

This is the last VIP tranche (3/3) from the Chaos Labs Recommendations
