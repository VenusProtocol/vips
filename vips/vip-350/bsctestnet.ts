...
export const ZKSYNCSEPOLIA_TREASURY = "0x943eBE4460a12F551D60A68f510Ea10CD8d564BA";
export const XVS = "0xB9e0E753630434d7863528cc73CB7AC638a7c8ff";

export const RECEIVER_ADDRESS = ethers.utils.defaultAbiCoder.encode(["address"], [ZKSYNCSEPOLIA_TREASURY]);
export const ADAPTER_PARAMS = ethers.utils.solidityPack(["uint16", "uint256"], [1, 300000]);
export const XVS_AMOUNT = parseUnits("7200", 18);
export const DEST_CHAIN_ID = 10248;

export const vip350 = () => {
  const meta = {
    version: "v2",
    title: "VIP to transfer XVS to destination chain(Zksync sepolia)",
    description: ``,
