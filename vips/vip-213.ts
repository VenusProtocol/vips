...
This VIP will perform the following Risk Parameters actions as per Chaos Labs latest recommendations.

- **MATIC** (Core pool)
    - Increase supply cap to 16,000,000 (from 8,000,000)
- **PLANET** (Defi pool)
    - Increase supply cap to 4,000,000,000 (from 2,000,000,000)
    - Increase borrow cap to 1,500,000,000 (from 1,000,000,000)

Complete analysis and details of these recommendations are available in the above publication.

VIP simulation: https://github.com/VenusProtocol/vips/pull/122`,
