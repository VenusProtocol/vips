  ...
  return makeProposal(
    [
      ...
      },
      {
        ...
        params: [
          increaseExchangeRateByPercentage(weETH_Initial_Exchange_Rate, BigNumber.from("503")),
          1747589544,
        ],
        dstChainId: LzChainId.unichainsepolia,
      },
      ...
      },
      {
        ...
        signature: "setSnapshot(uint256,uint256)",
        params: [
          increaseExchangeRateByPercentage(wstETH_Initial_Exchange_Rate, BigNumber.from("607")),
          1747589544,
        ],
        dstChainId: LzChainId.unichainsepolia,
      },
