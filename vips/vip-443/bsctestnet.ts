...
const FIXED_SOL_PRICE = parseUnits("236.12", 18);
...
export const marketSpec = {
  ...
  interestRateModel: {
    address: "0xF1A8B40CA68d08EFfa31a16a83f4fd9b5c174872",
    base: "0.02",
    multiplier: "0.2",
    jump: "3",
    kink: "0.5",
  ...
  return makeProposal(
    [
      // Configure Oracle
      {
        ...
        params: [marketSpec.vToken.underlying.address, FIXED_SOL_PRICE],
      },
      {
