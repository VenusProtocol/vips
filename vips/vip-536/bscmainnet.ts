...
export const CHAOS_LABS_USDC_AMOUNT = parseUnits("66667", 18);
export const PESSIMISTIC_USDT_AMOUNT = parseUnits("4375", 18);

export const vip536 = () => {
  const meta: ProposalMeta = {
    version: "v2",
    title: "VIP-536 Payments issuance for audits and other expenses",
    description: `**Summary**

If passed this VIP will perform the following actions:

- Transfer 32,500 USDC from the [Venus Treasury on BNB Chain](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9) to Quantstamp, for the retainer program (payment 3/4)
- Transfer 17,500 USDT from the [Venus Treasury on BNB Chain](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9) to Certik, for the retainer program (August 2025)
- Transfer 4,375 USDT from the [Venus Treasury on BNB Chain](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9) to Pessimistic, for the audit of the Venus ERC4626 wrapper on the VTokens of Core pool on BNB Chain
- Transfer 66,667 USDC from the [Venus Treasury on BNB Chain](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9) to Chaos Labs for risk management services
...
- Concept: Retainer program renewal - 3/4 monthly payment. Quantstamp will charge $130,000 in total for the security services provided in [their proposal](https://community.venus.io/t/quantstamp-retainer-renewal-for-ongoing-security-audits/5101). This will be paid in four monthly installments of $32,500 in USDC from the Venus Treasury, with the first paid on or around June 1st, 2025, and the fourth and final payment to be made on or around September 1st, 2025.
- References:
...
- Concept: Retainer program - monthly payment of August 2025.
...
- Payload: [Venus ERC4626 wrapper on the VTokens of Core pool on BNB Chain](https://github.com/VenusProtocol/ERC4626/pull/2)
- Status: audit started on July 28th, 2025. Public report estimated by August 7th, 2025
...
- Risk Management services from August 1st, 2025 to September 30th, 2025
- References:
...
- Cost: 66,667 USDC, to be sent to the BEP20 address 0xb98D807cDD58a35d2Fca300bEBC06ac39A7CE038

**References**

- [VIP simulation](https://github.com/VenusProtocol/vips/pull/597)`,
