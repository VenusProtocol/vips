...
- [weETH (Liquid Staking)](https://bscscan.com/address/${ETH_weETH__ADDRESS})
...
| ---------------------------------------------------------------------------- | ------------------ | ---------------------- | ------------------ | ----------------------- |
| [TUSD (Core)](https://bscscan.com/address/${CORE_TUSD_ADDRESS})              | 1,500,00	          | 750,000                | 1,200,000          |	600,000                 |
| [ankrBNB (DeFi)](https://bscscan.com/address/${DEFI_ankrBNB_ADDRESS})        | 10,000             | 500                    | 4,000              | 250                     |
| [USDD (DeFi)](https://bscscan.com/address/${DEFI_USDD_ADDRESS})              | 450,000            | 100,000                | 300,000            | 90,000                  |
| [BSW (DeFi)](https://bscscan.com/address/${DEFI_BSW_ADDRESS})                | 11,600,000         | 3,000,000              |	5,800,000         | 1,500,000               |
| [TWT (DeFi)](https://bscscan.com/address/${DEFI_TWT_ADDRESS})                | 3,000,000          | No Change              | 500,000            | 100,000                 |
| [ALPACA (DeFi)](https://bscscan.com/address/${DEFI_ALPACA_ADDRESS})          | 1,500,000          | No Change              | 750,000            | 100,000                 |
| [PLANET (DeFi)](https://bscscan.com/address/${DEFI_PLANET_ADDRESS})          | 4,000,000,000      | 2,000,000,000          | 1,500,000,000      | 750,000,000             |
| [ANKR (DeFi)](https://bscscan.com/address/${DEFI_ANKR_ADDRESS})              | 17,700,000         | 2,000,000              | 8,850,000          | 1,000,000               |
| [USDD (GameFi)](https://bscscan.com/address/${GAMEFI_USDD_ADDRESS})          | 450,000            | 100,000                | 300,000            | 90,000                  |
| [RACA (GameFi)](https://bscscan.com/address/${GAMEFI_RACA_ADDRESS})          | 4,200,000,000      | 1,000,000,000          | 2,100,000,000      | 500,000,000             |
| [FLOKI (GameFi)](https://bscscan.com/address/${GAMEFI_FLOKI_ADDRESS})        | 68,000,000,000     | No Change              | 22,000,000,000     | 2,000,000,000           |
| [USDD (Stablecoins)](https://bscscan.com/address/${STABLE_USDD_ADDRESS})     | 240,000            | 100,000                | 160,000            | 90,000                  |
| [lisUSD (Stablecoins)](https://bscscan.com/address/${STABLE_lisUSD_ADDRESS}) | 1,000,000          | 200,000                | 250,000            | 100,000                 |
| [USDT (Stablecoins)](https://bscscan.com/address/${STABLE_USDT_ADDRESS})     | 960,000            | 500,000                | 640,000            | 400,000                 |
| [USDD (Tron)](https://bscscan.com/address/${TRON_USDD_ADDRESS})              | 2,700,000          | 500,000                | 1,800,000          | 400,000                 |
| [USDT (Tron)](https://bscscan.com/address/${TRON_USDT_ADDRESS})              | 1,380,000          | 500,000                | 920,000            | 400,000                 |
| [BTT (Tron)](https://bscscan.com/address/${TRON_BTT_ADDRESS})                | 1,130,000,000,000  | 100,000,000,000        |	565,000,000,000   | 50,000,000,000          |
| [TRX (Tron)](https://bscscan.com/address/${TRON_TRX_ADDRESS})                | 6,300,000          | 2,000,000              | 3,150,000          | 1,000,000               |
| [WIN (Tron)](https://bscscan.com/address/${TRON_WIN_ADDRESS})                | 2,300,000,000      | 500,000,000            | 1,150,000,000      | 250,000,000             |

### Ethereum

| Asset                                                             | Current Supply Cap | Recommended Supply Cap |	Current Borrow Cap | Recommended Borrow Cap  |
| ----------------------------------------------------------------- | ------------------ | ---------------------- | ------------------ | ----------------------- |
[DAI (Core)](https://etherscan.io/address/${ETH_DAI_ADDRESS})       | 50,000,000         | 5,000,000              | 45,000,000         | 4,500,000               |
[FRAX (Core)](https://etherscan.io/address/${ETH_FRAX_ADDRESS})     | 10,000,000         | 2,000,000              | 8,000,000          | 1,600,000               |
[crvUSD (Core)](https://etherscan.io/address/${ETH_crvUSD_ADDRESS}) | 50,000,000         | 10,000,000             | 45,000,000         | 9,000,000               |
[CRV (Core)](https://etherscan.io/address/${ETH_CRV_ADDRESS})       | 6,000,000          | 3,000,000              | 3,000,000          | 1,500,000               |

Complete analysis and details of these recommendations are available in the above publication.

VIP simulation: [https://github.com/VenusProtocol/vips/pull/278](https://github.com/VenusProtocol/vips/pull/289)
    ...
    [
      ...
      },
      {
        ...
        params: [
          ...
          [DEFI_ankrBNB_SUPPLY_CAP, DEFI_USDD_SUPPLY_CAP, DEFI_BSW_SUPPLY_CAP, DEFI_PLANET_SUPPLY_CAP, DEFI_ANKR_SUPPLY_CAP]
        ],
      },
      {
        target: DEFI_COMPTROLLER_ADDRESS,
        signature: "setMarketBorrowCaps(address[],uint256[])",
        params: [
          [DEFI_ankrBNB_ADDRESS, DEFI_USDD_ADDRESS, DEFI_BSW_ADDRESS, DEFI_TWT_ADDRESS, DEFI_PLANET_ADDRESS, DEFI_ANKR_ADDRESS, DEFI_ALPACA_ADDRESS],
          [DEFI_ankrBNB_BORROW_CAP, DEFI_USDD_BORROW_CAP, DEFI_BSW_BORROW_CAP, DEFI_TWT_BORROW_CAP, DEFI_PLANET_BORROW_CAP, DEFI_ANKR_BORROW_CAP, DEFI_ALPACA_BORROW_CAP]
        ],
      },
      {
