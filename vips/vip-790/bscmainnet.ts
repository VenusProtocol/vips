...
export const ZKSYNC_XVS_BRIDGE_AMOUNT = parseUnits("2", 18);
...
export const UNICHAIN_XVS_BRIDGE_AMOUNT = parseUnits("2", 18);
...
export const BSC_XVS_AMOUNT = parseUnits("2", 18);
...
export const ETH_XVS_AMOUNT = parseUnits("2", 18);
...
export const ARB_XVS_AMOUNT = parseUnits("2", 18);
