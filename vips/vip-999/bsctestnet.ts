...
Both revert with \`InvalidConsentHash\` if \`consentHash\` is zero. The plain \`deposit\`/\`mint\` entrypoints are unchanged. Existing vaults are immutable clones and are not modified; the change applies to vaults created from now on.
