// All raw on-chain addresses used by VIP-665, grouped by chain and purpose. actionPlan.ts, cleanup.ts,
// the VIP and the simulations reference these named constants so the plan files stay free of literals.
import { NETWORK_ADDRESSES } from "src/networkAddresses";

import type { RemoteChain } from "./actionPlan";
...
// Markets whose syncCash() role is currently granted per-market to the NormalTimelock, per chain.
...
// Contracts the redundant-grant cleanup is scoped to, per chain.
