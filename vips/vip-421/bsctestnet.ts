  ...
  return makeProposal(
    [
...

      {
        ...
        signature: "setConversionConfigs(address,address[],(uint256,uint8)[])",
        params: [sepoliaBaseAssets[0], sepoliaUSDTPrimeConverterTokenOuts, incentiveAndAccessibilities],
        dstChainId: LzChainId.sepolia,
      },
      {
        target: SEPOLIA_USDC_PRIME_CONVERTER,
        signature: "setConversionConfigs(address,address[],(uint256,uint8)[])",
        params: [sepoliaBaseAssets[1], sepoliaUSDCPrimeConverterTokenOuts, incentiveAndAccessibilities],
        dstChainId: LzChainId.sepolia,
      },
      {
        target: SEPOLIA_WBTC_PRIME_CONVERTER,
        signature: "setConversionConfigs(address,address[],(uint256,uint8)[])",
        params: [sepoliaBaseAssets[2], sepoliaWBTCPrimeConverterTokenOuts, incentiveAndAccessibilities],
        dstChainId: LzChainId.sepolia,
      },
      {
        target: SEPOLIA_WETH_PRIME_CONVERTER,
        signature: "setConversionConfigs(address,address[],(uint256,uint8)[])",
        params: [sepoliaBaseAssets[3], sepoliaWETHPrimeConverterTokenOuts, incentiveAndAccessibilities],
        dstChainId: LzChainId.sepolia,
      },
      {
        target: SEPOLIA_XVS_VAULT_CONVERTER,
        signature: "setConversionConfigs(address,address[],(uint256,uint8)[])",
        params: [sepoliaBaseAssets[4], sepoliaXVSVaultConverterTokenOuts, incentiveAndAccessibilities],
        dstChainId: LzChainId.sepolia,
      },
    ],
