...
const BURNING_CONVERTER = "0x9eF79830e626C8ccA7e46DCEd1F90e51E7cFCeBE";
...
export const vip521 = (overrides: { maxStalePeriod?: number }) => {
  const meta: ProposalMeta = {
    version: "v2",
    title: "VIP-521 [BNB Chain] Enable BNB and FDUSD as Prime Markets on BNB Chain",
    description: `VIP-521 [BNB Chain] Enable BNB and FDUSD as Prime Markets on BNB Chain
