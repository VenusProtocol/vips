...
export const vip521addendum = () => {
  const meta: ProposalMeta = {
    version: "v2",
    title: "VIP-521 Addendum to configure USDF conversions on WBNBBurnConverter",
    description: `VIP-521 Addendum to configure USDF conversions on WBNBBurnConverter`,
