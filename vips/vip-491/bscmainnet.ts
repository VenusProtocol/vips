...
export const vip491 = () => {
  const meta = {
    version: "v2",
    title: "VIP-3189 Unwind PT Markets (BNB Chain and Ethereum)",
    description: "",
  ...
  return makeProposal(
    [
      // === BNB Chain ===
      // --- Market: PT-clisBNB-APR25 ---
      {
        target: COMPTROLLER_LiquidStakedBNB,
        signature: "setCollateralFactor(address,uint256,uint256)",
        params: [VToken_vPT_clisBNB_APR25_LiquidStakedBNB, parseUnits("0", 18), parseUnits("0", 18)],
      },
      {
        target: COMPTROLLER_LiquidStakedBNB,
      ...
      //   // === Ethereum ===
      //   // --- Market: PT-USDe-MAR25 ---
      {
        target: Comptroller_Ethena,
        signature: "setCollateralFactor(address,uint256,uint256)",
        params: [VToken_vPT_USDe_27MAR2025_Ethena, parseUnits("0", 18), parseUnits("0", 18)],
      ...
      // --- Market: PT-sUSDE-MAR25 ---
      {
        target: Comptroller_Ethena,
        signature: "setCollateralFactor(address,uint256,uint256)",
        params: [VToken_vPT_sUSDE_27MAR2025_Ethena, parseUnits("0", 18), parseUnits("0", 18)],
        dstChainId: LzChainId.ethereum,
      },
      {
        target: Comptroller_Ethena,
      ...
      },
      {
        target: Comptroller_LiquidStakedETH,
        signature: "setActionsPaused(address[],uint8[],bool)",
        params: [[VToken_vPT_weETH_26DEC2024_LiquidStakedETH], [Actions.MINT, Actions.ENTER_MARKET], true],
        dstChainId: LzChainId.ethereum,
      },
      {
