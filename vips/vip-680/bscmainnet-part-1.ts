...
//
// GAS (bscmainnet fork at block 112783065): propose() 6,267,444 (37.4% of the 16,777,216 per-tx cap),
// queue() 1,976,072, execute() 11,973,069 (71.4%). testVip asserts the cap on all three. propose() is
