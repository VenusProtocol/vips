...
export const NEW_VBEP20_DELEGATE_IMPL = "0x1be1CE8352328278Ac4e0488436c0f1607282550";
...
export const CORE_MARKETS = [
  ...
  },
  {
    ...
    underlying: "0xe052823b4aefc6e230FAf46231A57d0905E30AE0",
  ...
  {
    symbol: "vXAUM",
    underlying: "0x23AE4fd8E7844cdBc97775496eBd0E8248656028",
    address: "0x92e6Ea74a1A3047DabF4186405a21c7D63a0612A",
  },
  {
    symbol: "vXRP",
...
- **VIP execution simulation**: in a simulation environment, validating the new implementation is properly set on BNB Chain
- **Deployment on testnet**: the same upgrade has been performed on BNB Chain testnet

#### Deployed contracts

- [New VBep20Delegate implementation](https://bscscan.com/address/${NEW_VBEP20_DELEGATE_IMPL})
