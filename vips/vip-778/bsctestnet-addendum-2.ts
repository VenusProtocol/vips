...
export const vip778Addendum2 = () => {
  const meta = {
    version: "v2",
    title: "VIP-778 Addendum 2: Unpause Mint and Update CF for vETH_Core and vWBNB_Core on BSC Testnet",
    description: ``,
...
export default vip778Addendum2;
