  ...
  return makeProposal(
    [
      // opbnbsepolia
      {
        ...
        params: [RISK_STEWARD_RECEIVER_OPBNBTESTNET, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_OPBNBTESTNET],
      ...
      // arbitrumsepolia
      {
        ...
        signature: "giveCallPermission(address,string,address)",
        params: [RISK_STEWARD_RECEIVER_ARBITRUMSEPOLIA, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_ARBITRUMSEPOLIA],
      ...
      },
      {
        target: ACCESS_CONTROL_MANAGER_ARBITRUMSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketSupplyCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_ARBITRUMSEPOLIA],
        dstChainId: LzChainId.arbitrumsepolia,
      },
      {
        target: ACCESS_CONTROL_MANAGER_ARBITRUMSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketBorrowCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_ARBITRUMSEPOLIA],
        dstChainId: LzChainId.arbitrumsepolia,
      },
      // opsepolia
      {
        ...
        signature: "giveCallPermission(address,string,address)",
        params: [RISK_STEWARD_RECEIVER_OPSEPOLIA, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_OPSEPOLIA],
      ...
      // basesepolia
      {
        ...
        signature: "giveCallPermission(address,string,address)",
        params: [RISK_STEWARD_RECEIVER_BASESEPOLIA, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_BASESEPOLIA],
      ...
      // unichainsepolia
      {
        ...
        signature: "giveCallPermission(address,string,address)",
        params: [RISK_STEWARD_RECEIVER_UNICHAINSEPOLIA, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_UNICHAINSEPOLIA],
      ...
      },
      {
        target: ACCESS_CONTROL_MANAGER_UNICHAINSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketSupplyCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_UNICHAINSEPOLIA],
        dstChainId: LzChainId.unichainsepolia,
      },
      {
        target: ACCESS_CONTROL_MANAGER_UNICHAINSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketBorrowCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_UNICHAINSEPOLIA],
        dstChainId: LzChainId.unichainsepolia,
      },
      // zksyncsepolia
      {
        ...
        signature: "giveCallPermission(address,string,address)",
        params: [RISK_STEWARD_RECEIVER_ZKSYNCSEPOLIA, "setRiskParameterConfig(string,address,uint256)", NORMAL_TIMELOCK_ZKSYNCSEPOLIA],
      ...
      },
      {
        target: ACCESS_CONTROL_MANAGER_ZKSYNCSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketSupplyCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_ZKSYNCSEPOLIA],
        dstChainId: LzChainId.zksyncsepolia,
      },
      {
        target: ACCESS_CONTROL_MANAGER_ZKSYNCSEPOLIA,
        signature: "giveCallPermission(address,string,address)",
        params: [ANY_TARGET_CONTRACT, "setMarketBorrowCaps(address[],uint256[])", MARKET_CAP_RISK_STEWARD_ZKSYNCSEPOLIA],
        dstChainId: LzChainId.zksyncsepolia,
      },
    ],
    meta,
