...
const JUMPRATEMODEL_BASE0BPS_SLOPE1000BPS_JUMP25000BPS_KINK8000BPS = "0x62A8919C4C413fd4F9aef7348540Bc4B1b5CC805";
...
export const NEW_VTUSD_IR = JUMPRATEMODEL_BASE0BPS_SLOPE1000BPS_JUMP25000BPS_KINK8000BPS;
...
const vip308 = () => {
  const meta = {
    version: "v2",
    title: "VIP-308 Risk Parameters Adjustments (Stablecoins)",
    description: `If passed, this VIP will perform the set changes recommended by Chaos Labs in this Venus community forum publication: [Chaos Labs - Stablecoin IR Updates - 05/17/24](https://community.venus.io/t/chaos-labs-stablecoin-ir-updates-05-17-24/4332).

- BNB chain
    - Decrease multiplier (annualized), from 0.1 (8% APR at kink) to 0.0875 (7% APR at kink): [USDT (Core pool)](https://bscscan.com/address/0xfD5840Cd36d94D7229439859C0112a4185BC0255) and [USDC (Core pool)](https://bscscan.com/address/0xecA88125a5ADbe82614ffC12D0DB554E2e2867C8)
    - Decrease multiplier (annualized), from 0.125 (10% APR at kink) to 0.0875 (7% APR at kink): [DAI (Core pool)](https://bscscan.com/address/0x334b3eCB4DCa3593BCCC3c7EBD1A1C1d1780FBF1) and [FDUSD (Core pool)](https://bscscan.com/address/0xC4eF4229FEc74Ccfe17B2bdeF7715fAC740BA0ba)
    - Decrease multiplier (annualized), from 0.125 (10% APR at kink) to 0.1 (8% APR at kink): [TUSD (Core pool)](https://bscscan.com/address/0xBf762cd5991cA1DCdDaC9ae5C638F5B5Dc3Bee6E) and [USDT (Stablecoins)](https://bscscan.com/address/0x5e3072305F9caE1c7A82F6Fe9E38811c74922c3B)
    - Decrease multiplier (annualized), from 0.175 (14% APR at kink) to 0.15 (12% APR at kink): [USDT (GameFi)](https://bscscan.com/address/0x4978591f17670A846137d9d613e333C38dc68A37) and [USDT (DeFi)](https://bscscan.com/address/0x1D8bBDE12B6b34140604E18e9f9c6e14deC16854)
- Ethereum
    - Decrease multiplier (annualized), from 0.125 (10% APR at kink) to 0.0875 (7% APR at kink): [USDT (Core pool)](https://etherscan.io/address/0x8C3e3821259B82fFb32B2450A95d2dcbf161C24E), [USDC (Core pool)](https://etherscan.io/address/0x17C07e0c232f2f80DfDbd7a95b942D893A4C5ACb), [crvUSD (Core pool)](https://etherscan.io/address/0x672208C10aaAA2F9A6719F449C4C8227bc0BC202)

Complete analysis and details of these recommendations are available in the above publications.

VIP simulation: [https://github.com/VenusProtocol/vips/pull/290](https://github.com/VenusProtocol/vips/pull/290)

#### Disclaimer for Ethereum commands

Privilege commands on Ethereum will be executed by the [Guardian wallet](https://etherscan.io/address/0x285960C5B22fD66A736C7136967A3eB15e93CC67), until the [Multichain Governance](https://docs-v4.venus.io/technical-reference/reference-technical-articles/multichain-governance) contracts are deployed. If this VIP passes, [this](https://app.safe.global/transactions/tx?safe=eth:0x285960C5B22fD66A736C7136967A3eB15e93CC67&id=multisig_0x285960C5B22fD66A736C7136967A3eB15e93CC67_0xabec36a214fcc2d7a93c82cf2da28b280281ea40eaca55d8bf96cc296ec95173) multisig transaction will be executed. Otherwise, they will be rejected.`,
