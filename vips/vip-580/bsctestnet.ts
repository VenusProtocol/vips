...
export const vip580Testnet = () => {
  const meta = {
    version: "v2",
    title: "VIP-580 Configure DeviationSentinel and SentinelOracle on BSC Testnet",
    description: `#### Summary
...
- [VIP Pull Request](https://github.com/VenusProtocol/vips/pull/XXX)
