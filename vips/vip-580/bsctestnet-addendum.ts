...
export const vip580TestnetAddendum = () => {
  const meta = {
    version: "v2",
    title: "VIP-580 Addendum: Grant _setActionsPaused permission to DeviationSentinel on BSC Testnet",
    description: `#### Summary

This addendum to VIP-580 grants the missing \`_setActionsPaused(address[],uint8[],bool)\` permission to the DeviationSentinel contract on BSC Testnet.

#### Description

The original VIP-580 granted the \`setActionsPaused(address[],uint8[],bool)\` permission but missed the underscore-prefixed version \`_setActionsPaused(address[],uint8[],bool)\` which is the actual internal function signature used by comptrollers.
...
export default vip580TestnetAddendum;
