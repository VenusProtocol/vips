    ...
    [
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          ...
          params: [converter, "setMinAmountToConvert(uint256)", ethereum.NORMAL_TIMELOCK],
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          target: ETHEREUM_ACM,
          signature: "giveCallPermission(address,string,address)",
          params: [converter, "setMinAmountToConvert(uint256)", ETHEREUM_FASTTRACK_TIMELOCK],
          dstChainId: LzChainId.ethereum,
        }
      }),
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          target: ETHEREUM_ACM,
          signature: "giveCallPermission(address,string,address)",
          params: [converter, "setMinAmountToConvert(uint256)", ETHEREUM_CRITICAL_TIMELOCK],
          dstChainId: LzChainId.ethereum,
        }
      }),
    ],
