...
export const vip337 = () => {
  const meta = {
    version: "v1",
    title: "VIP-337 Partial liquidation of the BNB bridge exploiter account",
    description: `#### Summary
...
- Redeem 276,060,909.74786926 [vUSDC](https://bscscan.com/address/0xeca88125a5adbe82614ffc12d0db554e2e2867c8) held by the [Venus Treasury](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9), getting around 6.7M USDC
...
- Redeem 100% of the seized vBNB tokens and transfer them to [Venus Treasury](https://bscscan.com/address/0xf322942f644a996a617bd29c16bd7d231d9f35e9)
...
- The USDC debt of the BNB bridge exploiter will be reduced by (around) 6.7M USDC
- Around $7.37M in BNB will have been transferred to Venus Treasury
