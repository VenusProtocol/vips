...
export const ARBITRUM_ONE_REWARD_DISTRIBUTORS = ["0x53b488baA4052094495b6De9E5505FE1Ee3EAc7a"];
export const ETHEREUM_REWARD_DISTRIBUTORS = [
...
const vip356 = () => {
  ...
  return makeProposal(
    [
      ...
      ...ETHEREUM_REWARD_DISTRIBUTORS.map(rewardDistributor => {
        return {
          target: ETHEREUM_ACM,
          signature: "revokeCallPermission(address,string,address)",
          params: [rewardDistributor, "setRewardTokenSpeeds(address[],uint256[],uint256[])", ethereum.GUARDIAN],
