    ...
    [
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          ...
          params: [converter, "setConversionConfig(address,address,ConversionConfig)", ethereum.NORMAL_TIMELOCK],
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          target: ETHEREUM_ACM,
          signature: "giveCallPermission(address,string,address)",
          params: [converter, "setConversionConfig(address,address,ConversionConfig)", ETHEREUM_FASTTRACK_TIMELOCK],
          dstChainId: LzChainId.ethereum,
        };
      }),
      ...
      ...ETHEREUM_CONVERTERS.map(converter => {
        return {
          target: ETHEREUM_ACM,
          signature: "giveCallPermission(address,string,address)",
          params: [converter, "setConversionConfig(address,address,ConversionConfig)", ETHEREUM_CRITICAL_TIMELOCK],
          dstChainId: LzChainId.ethereum,
        };
      }),
    ],
