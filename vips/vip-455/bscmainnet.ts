...
export const remoteBridgeEntries: RemoteBridgeEntry[] = [
  {
    ...
    maxDailyLimit: parseUnits("0", 18),
    maxSingleTransactionLimit: parseUnits("0", 18),
    maxDailyReceiveLimit: parseUnits("0", 18),
    maxSingleReceiveTransactionLimit: parseUnits("0", 18),
  },
  {
